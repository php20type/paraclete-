...
class DavinciConfigController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.davinci.configuration.index', compact('languages', 'voiceover_languages', 'voices', 'settings', 'models', 'notification', 'type'));
    }
    ...
    public function store(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (request('chat-real-time-data') == 'on') {
                $this->storeConfiguration('DAVINCI_SETTINGS_CHAT_REAL_TIME_DATA', 'allow'); 
            } else {
                $this->storeConfiguration('DAVINCI_SETTINGS_CHAT_REAL_TIME_DATA', 'deny');
            }
