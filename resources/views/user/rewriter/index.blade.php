					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-2 ml-3 fs-16 number-font">{{ __('AI ReWriter') }} 										
									</h6>
								</div>									
							</div>								
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="input-box">	
								...
								<div class="form-group">						    
									<textarea rows="15" cols="50" type="text" class="form-control @error('prompt') is-danger @enderror" id="prompt" name="prompt" placeholder="{{ __('Paste your text that you wish to rewrite or improve...') }}" required></textarea>
									@error('prompt')
