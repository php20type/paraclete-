				...
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						...
						@foreach ($template->fields as $value)
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold">{{ __($value['name']) }}</h6>									
									<div class="form-group">						  
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="input-box mt-5">
								<h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Number of Results') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Maximum supported results is 10') }}"></i></h6>
								<div class="form-group">
									<input type="number" class="form-control @error('max_results') is-danger @enderror" id="max_results" name="max_results" placeholder="e.g. 5" max="10" min="1" value="1">
									@error('max_results')
