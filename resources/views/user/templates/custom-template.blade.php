			...
			<div class="card border-0" id="template-input">
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						...
						@foreach ($template->fields as $value)
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold">{{ __($value['name']) }} 
										@if (isset($value['status']))
											@if ($value['status'] == 'required') <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> @endif
										@endif
									</h6>									
									<div class="form-group">						  
										@if ($value['input'] == 'input')
											<input type="text" class="form-control" id="{{ $value['code'] }}" name="{{ $value['code'] }}" placeholder="{{ __($value['placeholder']) }}">
										@elseif ($value['input'] == 'textarea')
											<textarea type="text" rows=5 class="form-control" id="{{ $value['code'] }}" name="{{ $value['code'] }}" placeholder="{{ __($value['placeholder']) }}"></textarea>
										@elseif ($value['input'] == 'select')									
											<select id="{{ $value['code'] }}" name="{{ $value['code'] }}" class="form-select">
											...
											<div class="checkbox-wrapper d-flex">
												@foreach ($value['placeholder'] as $option)
													<div class="form-check fs-12 mr-4">
														<input class="form-check-input" type="checkbox" value="{{ $option }}" name="{{ $value['code'] }}" id="{{ $option }}">
										...
										@elseif ($value['input'] == 'radio')	
											<div class="radio-wrapper d-flex">
												@foreach ($value['placeholder'] as $option)
													<div class="form-check fs-12 mr-4">
														<input class="form-check-input" type="radio" value="{{ $option }}" name="{{ $value['code'] }}" id="{{ $option }}">
														<label class="form-check-label" for="{{ $option }}">{{ $option }}</label>
													</div>
												@endforeach
											</div>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box mt-5">								
								<h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Estimated Result Length') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Estimated words length for each generated text result') }}"></i></h6>
								<div class="form-group">							    
