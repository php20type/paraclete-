													...
													<div class="card p-5 mb-4 pl-7 pr-7 h-100 price-card @if ($subscription->featured) price-card-border @endif">
														...
														<div class="plan">			
															...
															<ul class="fs-12 pl-3">		
																...
																@if($subscription->smart_ads_feature) <li class="fs-14 mb-3"><i class="fa-solid fa-check fs-14 mr-2 text-success"></i> <span class="plan-feature-text">{{ __('Smart Ads Feature') }}</span></li> @endif
