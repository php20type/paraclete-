		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Update User Credits') }}</h3>
				</div>
				<div class="card-body">
					<form method="POST" action="{{ route('admin.user.increase', [$user->id]) }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-2">
								<div>
									<p class="fs-12 mb-2">{{ __('Full Name') }}: <span class="font-weight-bold ml-2">{{ $user->name }}</span></p>
								...
								<div class="row mt-4">
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2">{{ __('Available Images') }}: <span class="font-weight-bold ml-2">@if ($user->available_images == -1) {{ __('Unlimited') }} @else {{ number_format($user->available_images ) }} @endif</span></p>
									...
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2">{{ __('Available Prepaid Images') }}: <span class="font-weight-bold ml-2">{{ number_format($user->available_images_prepaid) }}</span></p>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Image Credits') }}</label>
										<input type="number" class="form-control @error('images') is-danger @enderror" value={{ $user->available_images }} name="images">
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Prepaid Image Credits') }}</label>
										<input type="number" class="form-control @error('images_prepaid') is-danger @enderror" value={{ $user->available_images_prepaid }} name="images_prepaid">								
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Character Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Prepaid Character Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Minutes Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Prepaid Minutes Credits') }}</label>
