														...
														<li class="nav-item text-center frontend-buttons">
															<?php if(Route::has('login')): ?>
																<div>
																	...
																	<?php else: ?>
																		<a href="<?php echo e(route('login')); ?>" class="btn btn-primary special-action-button" id="login-button"><?php echo e(__('Login')); ?></a>
							...
							<div class="col-md-8 col-sm-12" id="footer-links">
								...
								<div class="row w-100">
									...
									<div class="col-md-3 col-sm-12 footer-connect pr-0">
										...
										<h5 class="mt-6 mb-4"><?php echo e(__('Get Started Today')); ?></h5>
...
<?php endif; ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>