		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Update User Credits')); ?></h3>
				</div>
				<div class="card-body">
					<form method="POST" action="<?php echo e(route('admin.user.increase', [$user->id])); ?>" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-2">
								<div>
									<p class="fs-12 mb-2"><?php echo e(__('Full Name')); ?>: <span class="font-weight-bold ml-2"><?php echo e($user->name); ?></span></p>
								...
								<div class="row mt-4">
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2"><?php echo e(__('Available Images')); ?>: <span class="font-weight-bold ml-2"><?php if($user->available_images == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_images )); ?> <?php endif; ?></span></p>
									...
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2"><?php echo e(__('Available Prepaid Images')); ?>: <span class="font-weight-bold ml-2"><?php echo e(number_format($user->available_images_prepaid)); ?></span></p>
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_words_prepaid); ?> name="words_prepaid">								
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Image Credits')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_images); ?> name="images">
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Prepaid Image Credits')); ?></label>
										<input type="number" class="form-control <?php $__errorArgs = ['images_prepaid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_images_prepaid); ?> name="images_prepaid">								
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Character Credits')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_chars); ?> name="chars">	
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Prepaid Character Credits')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_chars_prepaid); ?> name="chars_prepaid">								
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Minutes Credits')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value=<?php echo e($user->available_minutes); ?> name="minutes">
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('User Prepaid Minutes Credits')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/users/list/increase.blade.php ENDPATH**/ ?>