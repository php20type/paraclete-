				...
				$.ajax({
					...
					success: function (data) {
						if (data == 'success') {
							...
							Swal.fire('<?php echo e(__('Chat Bot Already Deactivated')); ?>', '<?php echo e(__('Selected chat bot is already deactivated')); ?>', 'warning');
						}      
					},
					error: function(data) {
						Swal.fire({ type: 'error', title: 'Oops...', text: 'Something went wrong!' })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/davinci/chats/index.blade.php ENDPATH**/ ?>