						...
						<div class="row mt-2 mb-6">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									...
									<textarea class="form-control" name="privacy" rows="12" id="privacy" required><?php echo $information['privacy']; ?></textarea>
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									...
									<textarea class="form-control" name="terms" rows="12" id="terms" required><?php echo $information['terms']; ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/admin/frontend/page/index.blade.php ENDPATH**/ ?>