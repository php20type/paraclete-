								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="support-ticket" name="support-ticket" class="form-select" data-placeholder="<?php echo e(__('Enable/Disable Email Sending for Support Ticket Statuses')); ?>">	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="user-notification" name="user-notification" class="form-select" data-placeholder="<?php echo e(__('Enable/Disable User Notification View Panel')); ?>">	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/settings/global/index.blade.php ENDPATH**/ ?>