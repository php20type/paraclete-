...
<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/rte_theme_default.css')); ?>" />
 ...
 <header class="header-1">
      <div class="container">
           <div class="sec-title text-center mb-3">
                 <h2>Untitled</h2>
                 <a href="#"><img src="<?php echo e(URL::asset('img/flag.png')); ?>" alt="" /> English</a>
           </div>
...
<section class="PersonalDetails">
    <div class="container">
        ...
        <form class="resume-form" id="resumeForm" action="<?php echo e(route('resume.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-lg-6">
...
<script src="<?php echo e(URL::asset('js/rte.js')); ?>"></script>
<script src="<?php echo e(URL::asset('js/all_plugins.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/resume/index.blade.php ENDPATH**/ ?>