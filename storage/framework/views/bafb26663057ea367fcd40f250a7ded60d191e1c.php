            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <div class="text-center mb-9 mt-9 pt-5" id="contact-row">
                        ...
                        <div class="title">
                            <h6><span><?php echo e(__('Privacy Policy')); ?></span></h6>
                        </div>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/privacy-policy.blade.php ENDPATH**/ ?>