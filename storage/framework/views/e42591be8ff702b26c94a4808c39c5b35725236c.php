					...
					<div class="row">
						<div class="col-sm-12">
							<div class="text-left mb-5" id="balance-status">
								<span class="fs-11 text-muted pl-3"><i class="fa-sharp fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->available_minutes == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->available_minutes + auth()->user()->available_minutes_prepaid)); ?> <?php echo e(__('Minutes')); ?> <?php endif; ?></span></span>
							</div>							
						</div>	
						<div class="col-sm-12">								
							<!-- DRAG & DROP FILES -->
						...
						<div class="col-sm-12">
							<div class="form-group">	
								...
								<select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Specify Audio language')); ?>">
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="col-sm-12">
							<div id="form-group">
								...
								<select id="creativity" name="task" class="form-select" data-placeholder="<?php echo e(__('Specify Task Type')); ?>">
					...
					<div class="card-footer border-0 text-center p-0">
						<div class="w-100 pt-2 pb-2">
							<div class="text-center">
								...
								<button type="submit" name="submit" class="btn btn-primary mt-4 pl-7 pr-7 fs-11 pt-2 pb-2" id="generate"><?php echo e(__('Transcribe')); ?></button>
							</div>
						</div>							
					</div>	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/transcribe/index.blade.php ENDPATH**/ ?>