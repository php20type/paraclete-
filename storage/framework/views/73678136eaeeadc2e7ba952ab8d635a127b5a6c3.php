							...
							<div class="col-12">							
								<div class="input-box">	
									<h6><?php echo e(__('New User Registration')); ?></h6>
			  						<select id="registration" name="registration" class="form-select" data-placeholder="<?php echo e(__('Select Registration Option')); ?>:">			
							...
							<div class="col-12">							
								<div class="input-box">	
									<h6><?php echo e(__('New User Email Verification')); ?></h6>
			  						<select id="email-verification" name="email-verification" class="form-select" data-placeholder="<?php echo e(__('Select Email Verification Option')); ?>:">			
							...
							<div class="col-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Default Country')); ?></h6>
			  						<select id="user-country" name="country" class="form-select" data-placeholder="<?php echo e(__('Select Default User Country')); ?>:">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/settings/registration/index.blade.php ENDPATH**/ ?>