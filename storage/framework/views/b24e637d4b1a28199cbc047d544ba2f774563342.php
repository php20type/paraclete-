				...
				<div class="card border-0">
					...
					<div class="card-body pb-6">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-paypal fs-16 mr-2"></i>PayPal Payment Gateway <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-brands fa-cc-stripe fs-16 mr-2"></i>Stripe Payment Gateway <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/paystack.svg')); ?>" alt="Paystack" class="gateway-logo">Paystack Payment Gateway <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/razorpay.svg')); ?>" alt="Razorpay" class="gateway-logo">Razorpay Payment Gateway <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/mollie.svg')); ?>" alt="Mollie" class="gateway-logo gateway-small-logo">Mollie Payment Gateway <span class="text-primary">(<?php echo e(__('All Plans')); ?>)</span></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="<?php echo e(URL::asset('/img/payments/braintree.svg')); ?>" alt="Braintree" class="gateway-logo">Braintree Payment Gateway <span class="text-primary">(<?php echo e(__('Prepaid Plans')); ?>)</span></h6>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/admin/finance/settings/index.blade.php ENDPATH**/ ?>