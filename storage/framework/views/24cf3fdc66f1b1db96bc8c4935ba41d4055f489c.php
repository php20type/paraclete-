							...
							<div class="col-lg-6 col-md-6 col-sm-12 mt-2">
								<div class="input-box">	
									<h6><?php echo e(__('Login via Social Media')); ?> <span class="text-muted">(<?php echo e(__('OAuth')); ?>)</span></h6>
			  						<select id="login-oauth" name="login-oauth" class="form-select" data-placeholder="<?php echo e(__('Login via Social Media')); ?>:">			
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/settings/oauth/index.blade.php ENDPATH**/ ?>