...
unset($__errorArgs, $__bag); ?>
								...
								<div class="card border-0 special-shadow mb-7">							
									<div class="card-body">
										...
										<h6 class="fs-12 font-weight-bold mb-4"><i class="fa fa-gift text-info fs-14 mr-2"></i><?php echo e(__('Free Trial Options')); ?> <span class="text-muted">(<?php echo e(__('Free Tier User Group Only')); ?>)</span></h6>
								...
								<div class="card border-0 special-shadow mb-7">							
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">	
													<h6><?php echo e(__('AI Chat Real Time Data Feature')); ?> <span class="text-muted">(<?php echo e(__('For All Groups')); ?>)</span> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
													<div class="form-group">
														<label class="custom-switch">
															<input type="checkbox" name="chat-real-time-data" class="custom-switch-input" <?php if( config('settings.chat_real_time_data')  == 'allow'): ?> checked <?php endif; ?>>
															<span class="custom-switch-indicator"></span>
														</label>
													</div>
												</div>								
						...
						<div class="tab-pane fade" id="extended" role="tabpanel" aria-labelledby="extended-tab">
							<form id="extended-features-form" action="<?php echo e(route('admin.davinci.configs.store.extended')); ?>" method="POST" enctype="multipart/form-data">
								...
								<?php if($type == 'Regular License' || $type == ''): ?>
									<p class="fs-14" style="background:#FFE2E5; color:#ff0000; padding:1rem 2rem; border-radius: 0.5rem;"><?php echo e(__('Extended License is required in order to have access to these features')); ?></p>
								<?php else: ?>
									<div class="card border-0 special-shadow mt-0 mb-7">							
										<div class="card-body">

											<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-sharp fa-solid fa-video text-danger fs-14 mr-2"></i><?php echo e(__('AI Video Settings')); ?> <span class="text-muted">(<?php echo e(__('For All Groups')); ?>)</span></h6>
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="input-box">
														<h6><?php echo e(__('AI Text to Video Feature Access')); ?> <span class="text-muted">(<?php echo e(__('For Non-Subscribers')); ?>)</span> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
														<div class="form-group mt-3">
															<label class="custom-switch">
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="card border-0 special-shadow mt-0 mb-7">							
										<div class="card-body">
											...
											<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-sharp fa-solid fa-user-music text-danger fs-14 mr-2"></i><?php echo e(__('Voice Cloning Settings')); ?> <span class="text-muted">(<?php echo e(__('For All Groups')); ?>)</span></h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/davinci/configuration/index.blade.php ENDPATH**/ ?>