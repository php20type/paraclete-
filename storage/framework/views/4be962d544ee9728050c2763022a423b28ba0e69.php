							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">	
									<h6><?php echo e(__('Default Language')); ?> <span class="text-muted">(<?php echo e(__('For All Groups')); ?>)</span><span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										  <select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Select Default Language')); ?>:">	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="image-vendor" name="image-vendor" class="form-select" data-placeholder="<?php echo e(__('Set AI Image Service Vendor')); ?>">
												...
												<option value='both' <?php if(config('settings.image_vendor') == 'both'): ?> selected <?php endif; ?>> <?php echo e(__('Both (OpenAI & Stable Diffusion)')); ?></option>																															
											</select>
										</div>
									</div>
