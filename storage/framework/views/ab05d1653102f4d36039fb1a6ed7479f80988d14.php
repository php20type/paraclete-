			...
			<div class="border-0 templates-nav-header">
				<div class="card-body">
					<div>
						...
						<h3 class="card-title mb-3 ml-2 fs-20 super-strong"><i class="fa-solid fa-microchip-ai mr-2 text-primary"></i><?php echo e(__('AI Templates')); ?></h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/templates/index.blade.php ENDPATH**/ ?>