						...
						<tbody>
							<?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<tr>
									...
									<td><a href="<?php echo e(url('user/videos/pdfdownload')); ?>?link=<?php echo e(urlencode($video->file_link)); ?>&title=<?php echo e(urlencode($video->title)); ?>&type=<?php echo e(getUrlExtension($video->file_link)); ?>" download="<?php echo e($video->title); ?>">Download</a></td>
								</tr>
								<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/user/video/video_list.blade.php ENDPATH**/ ?>