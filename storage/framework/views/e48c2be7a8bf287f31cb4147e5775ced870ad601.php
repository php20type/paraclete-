...
<?php $__env->startSection('css'); ?>
    ...
    max-height: 830px;
		...
		#chat-system .action-0btn .chat-button {
	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">	
			<div class="col-sm-12 text-center">
				...
				<h6 class="mb-0 fs-12 text-muted"><?php echo e(isset($chat)?$chat->description:''); ?></h6>
				<div class="mb-4" id="balance-status">
					<span class="fs-11 text-muted pl-3"><i class="fa-sharp fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->available_words == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->available_words + auth()->user()->available_words_prepaid)); ?><?php endif; ?></span> <?php echo e(__('Words')); ?></span>
				</div>	
			</div>
				...
				<div class="chat-message-container" id="chat-system">
					<div class="card-header">
						<div class="w-100 pt-2 pb-2">
							<div class="d-flex">
								<div class="overflow-hidden mr-4"><img alt="Avatar" class="chat-avatar" src="<?php echo e(isset($chat) ? URL::asset($chat->logo) : ''); ?>"></div>
								<div class="widget-user-name"><span class="font-weight-bold"><?php echo e(isset($chat) ? __($chat->name) : ''); ?></span><br><span class="text-muted"><?php echo e(isset($chat) ?__($chat->sub_name) : ''); ?></span></div>
							</div>
						</div>
									...
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											<div class="msg left-msg text-center mt-9">
												<div class="message-img" style="background-image: url(<?php echo e(isset($chat) ?$chat->logo:''); ?>)"></div>
...
<script type="text/javascript">
	...
	const bot_avatar = "<?php echo e(isset($chat) ? $chat->logo : ''); ?>";
	const user_avatar = "<?php echo e(URL::asset(auth()->user()->profile_photo_path)); ?>";	
	const mic = document.querySelector('#mic-button');
	let eventSource = null;
	let isTranscribing = false;
	let chat_code = "<?php echo e(isset($chat) ? $chat->chat_code : ''); ?>";	
	let active_id;
	let default_message;
	let uploaded_image = '';
	...
	function process(message) {
		...
		fetch('/user/vision/process', {
			...
			.then(data => {
				eventSource = new EventSource("/user/vision/generate?conversation_id=" + active_id);				
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/vision/index.blade.php ENDPATH**/ ?>