...
unset($__errorArgs, $__bag); ?>	
						...
						<?php $__currentLoopData = $template->fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__($value['name'])); ?> 
										<?php if(isset($value['status'])): ?>
											<?php if($value['status'] == 'required'): ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> <?php endif; ?>
										<?php endif; ?>
									</h6>									
									<div class="form-group">						  
										<?php if($value['input'] == 'input'): ?>
											<input type="text" class="form-control" id="<?php echo e($value['code']); ?>" name="<?php echo e($value['code']); ?>" placeholder="<?php echo e(__($value['placeholder'])); ?>">
										<?php elseif($value['input'] == 'textarea'): ?>
											<textarea type="text" rows=5 class="form-control" id="<?php echo e($value['code']); ?>" name="<?php echo e($value['code']); ?>" placeholder="<?php echo e(__($value['placeholder'])); ?>"></textarea>
										<?php elseif($value['input'] == 'select'): ?>									
											<select id="<?php echo e($value['code']); ?>" name="<?php echo e($value['code']); ?>" class="form-select">
												<?php $__currentLoopData = $value['placeholder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($option); ?>"><?php echo e(__($option)); ?></option>	
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>																																																																																																																			
											</select>
										<?php elseif($value['input'] == 'checkbox'): ?>	
											<div class="checkbox-wrapper d-flex">
												<?php $__currentLoopData = $value['placeholder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<div class="form-check fs-12 mr-4">
														<input class="form-check-input" type="checkbox" value="<?php echo e($option); ?>" name="<?php echo e($value['code']); ?>" id="<?php echo e($option); ?>">
														<label class="form-check-label" for="<?php echo e($option); ?>"><?php echo e($option); ?></label>
													</div>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</div>
										<?php elseif($value['input'] == 'radio'): ?>	
											<div class="radio-wrapper d-flex">
												<?php $__currentLoopData = $value['placeholder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<div class="form-check fs-12 mr-4">
														<input class="form-check-input" type="radio" value="<?php echo e($option); ?>" name="<?php echo e($value['code']); ?>" id="<?php echo e($option); ?>">
														<label class="form-check-label" for="<?php echo e($option); ?>"><?php echo e($option); ?></label>
													</div>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/templates/custom-template.blade.php ENDPATH**/ ?>