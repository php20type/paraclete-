				...
				<div class="card-body p-0">
					<table class="table" id="database-backup">
						<tbody>
							...
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold"><?php echo e(__('OpenAI Model for Templates')); ?></span><span class="font-weight-bold"><?php echo e($id->model); ?></span></td></tr>
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold"><?php echo e(__('OpenAI Model for AI Chat')); ?></span><span class="font-weight-bold"><?php echo e($id->model_chat); ?></span></td></tr>
							...
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold"><?php echo e(__('Smart Ads Feature')); ?></span><?php if($id->smart_ads_feature): ?><i class="fa-solid fa-circle-check table-info-button green fs-20"></i><?php else: ?> <i class="fa-solid fa-circle-xmark red table-info-button fs-20"></i> <?php endif; ?></td></tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/finance/plans/show.blade.php ENDPATH**/ ?>