		...
		<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1"><?php echo e(__('Visiters Today')); ?> (<?php echo e(__('Registered')); ?>)</p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/admin/users/dashboard/index.blade.php ENDPATH**/ ?>