						...
						<table id='listUsersTable' class='table listUsersTable' width='100%'>
								<thead>
									<tr>	
										...
										<th width="7%"><?php echo e(__('Words Left')); ?></th>         	        	       	    						           	     	       	    						           	        	       	    						           	     	       	    						           	
										<th width="7%"><?php echo e(__('Images Left')); ?></th>         	        	       	    						           	     	       	    						           	        	       	    						           	     	       	    						           	
										<th width="7%"><?php echo e(__('Chars Left')); ?></th>         	        	       	    						           	     	       	    						           	        	       	    						           	     	       	    						           	
										<th width="7%"><?php echo e(__('Minutes Left')); ?></th>         	        	       	    						           	     	       	    						           	        	       	    						           	     	       	    						           	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/admin/users/list/index.blade.php ENDPATH**/ ?>