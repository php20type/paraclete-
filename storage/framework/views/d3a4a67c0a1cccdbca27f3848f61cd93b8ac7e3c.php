					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-16 number-font"><?php echo e(__('Blog Conclusion')); ?> <?php if($template->professional): ?> <span class="fs-8 btn btn-yellow ml-2"><i class="fa-sharp fa-solid fa-crown mr-2"></i><?php echo e(__('Pro')); ?></span> <?php endif; ?></h6>
								</div>
								<div>
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Blog Post Title')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" placeholder="e.g. 5 best places to visit in Spain" required>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('What is your blog post is about?')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" placeholder="e.g. describe your blog article" required></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/paraclete.ai/public_html/resources/views/user/templates/blog-conclusion.blade.php ENDPATH**/ ?>