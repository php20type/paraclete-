...
unset($__errorArgs, $__bag); ?>
					...
					<div>						
						<div id="template-textarea" class="pl-4 pr-4">		
							<?php if(!is_null($id->image)): ?>
							<div class="text-center mb-5 mt-2">
								<img src="<?php echo e($id->image); ?>" style="height: 300px; border-radius: 10px;" alt="AI Article Wizard Image">
							</div>								
							<?php endif; ?>				
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/documents/documents/show.blade.php ENDPATH**/ ?>