	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('user.documents.voiceovers')); ?>"> <?php echo e(__('All Voiceovers')); ?></a></li>
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-7">
						<div class="col-12 mb-5">
							<h6 class="font-weight-bold mb-1"><?php echo e(__('Workbook')); ?>: </h6>
							<span class="fs-14"><?php echo e($id->project); ?></span>
						</div>
						<div class="col-12 mb-5">
							<h6 class="font-weight-bold mb-1"><?php echo e(__('Title')); ?>: </h6>
					...
					<div class="border-0 text-right mb-2 mt-8">
						<a href="<?php echo e(route('user.documents.voiceovers')); ?>" class="btn btn-primary"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/documents/voiceover/show.blade.php ENDPATH**/ ?>